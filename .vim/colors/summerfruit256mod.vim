...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
    ...
    call <SID>X("NonText", "b7dce8", "000000", "")
    ...
    call <SID>X("StatusLineNC", "326d41", "132a19", "")
    call <SID>X("VertSplit", "3687a2", "3687a2", "")
    call <SID>X("Folded", "274f6a", "c3daea", "")
    ...
    " Specials
    call <SID>X("Todo", "cc0000", "ffdddd", "bold")
    ...
    call <SID>X("Error", "000000", "d40000", "")
    ...
    call <SID>X("jinjaOperator", "000000", "fbf4c7", "")
    call <SID>X("jinjaVariable", "92cd35", "fbf4c7", "")
    call <SID>X("jinjaAttribute", "dd7700", "fbf4c7", "")
    call <SID>X("jinjaSpecial", "008ffd", "fbf4c7", "")

    call <SID>X("ExtraWhitespace", "000000", "004499", "")
    call <SID>X("keywordGreen", "ddffdd", "005500", "")
    call <SID>X("keywordYellow", "ffffaa", "444400", "")
    call <SID>X("keywordRed", "ffdddd", "880000", "")
    call <SID>X("keywordPurple", "ffddff", "880088", "")
