...
hi Cursor guifg=#182227 guibg=#cc99ff gui=NONE
...
hi StatusLine guifg=#a0a0a0 guibg=#252c31 gui=bold,underline
hi StatusLineNC guifg=#808080 guibg=#252c31 gui=underline
hi Pmenu guifg=#bcdbff guibg=NONE gui=NONE
hi PmenuSel guifg=NONE guibg=#3f4b52 gui=NONE
hi IncSearch guifg=#182227 guibg=#9977ff gui=NONE
hi Search guifg=#182227 guibg=#9977ff gui=NONE
...
hi Function guifg=#dda790 guibg=NONE gui=NONE
hi Identifier guifg=#99cf50 guibg=NONE gui=NONE
hi Keyword guifg=#dda790 guibg=NONE gui=NONE
hi Label guifg=#8bb664 guibg=NONE gui=NONE
hi NonText guifg=#414e58 guibg=#252c31 gui=NONE
